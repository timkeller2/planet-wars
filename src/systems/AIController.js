export class AIController {
  ...
  performAction(aiPlanets) {
    ...
    // At 0 bonus, 0.1 penalty (10px = 1 ship). At high bonus (~0.4), 0.02 penalty (50px = 1 ship).
    ...
    targets.sort((a, b) => getTargetScore(a) - getTargetScore(b));
