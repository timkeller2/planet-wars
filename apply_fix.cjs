...
const keydownIdx = lines.findIndex(l => l.includes("window.addEventListener('keydown'"));
...
// Replace lines between mousedownIdx and keydownIdx
lines.splice(mousedownIdx, keydownIdx - mousedownIdx, replacementStr);

const newContent = lines.join('\n');
fs.writeFileSync('src/main.js', newContent, 'utf8');
console.log('Successfully updated src/main.js using line index splice!');
